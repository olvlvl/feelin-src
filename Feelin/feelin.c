...
#define LIBVERS "$VER: Feelin 11.20 (2007/07/19) © Olivier LAVIALE (gofromiel@gofromiel.com) (" OS " version)"
...
des classes natives. F*ck l'émulation !
...
************************************************************************************************/
	...
	IEXEC InitSemaphore(F_OBJECTS_ARBITER);
...
************************************************************************************************/
	...
	{
		IEXEC Alert(AG_OpenLib | AO_GraphicsLib);
	...
	{
		IEXEC Alert(AG_OpenLib | AO_Intuition);
	...
	{
	   IEXEC Alert(AG_OpenLib | AO_UtilityLib);
	...
	*/
	...
	{
	   IEXEC Alert(AG_OpenLib | AO_LayersLib);

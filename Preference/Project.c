...
F_METHOD_PROTO(void,Prefs_AddInt);
...
#ifndef F_NEW_STYLES
F_METHOD_PROTO(void,Prefs_ObtainAssociated);
F_METHOD_PROTO(void,Prefs_ReleaseAssociated);
#endif

F_METHOD_PROTO(void,Prefs_FileChange);
F_METHOD_PROTO(void,Prefs_Merge);

#ifdef F_NEW_STYLES_PREFERENCE
...
F_METHOD_PROTO(void,Prefs_ObtainStyleByName);
#endif
//+
...
///Class
        case FV_Query_ClassTags:
        {
            ...
            STATIC F_METHODS_ARRAY =
            {
                ...
                F_METHODS_ADD(Prefs_AddInt,             "AddInt"),
                ...
                #ifndef F_NEW_STYLES
                F_METHODS_ADD(Prefs_ObtainAssociated,   "ObtainAssociated"),
                F_METHODS_ADD(Prefs_ReleaseAssociated,  "ReleaseAssociated"),
                #endif
                ...
                #ifdef F_NEW_STYLES
                F_METHODS_ADD(Prefs_GetProperty, "FM_CSSDocument_GetProperty"),
                F_METHODS_ADD(Prefs_AddProperty, "FM_CSSDocument_AddProperty"),

                F_METHODS_ADD(Prefs_ObtainStyle, "ObtainStyle"),
                F_METHODS_ADD(Prefs_ReleaseStyle, "ReleaseStyle"),
                F_METHODS_ADD(Prefs_ObtainStyleByName, "ObtainStyleByName"),
                #endif

...
///Class
		case FV_Query_ClassTags:
		{
			...
			{
				F_METHODS_OVERRIDE_STATIC(SB_New,       FM_New),
				F_METHODS_OVERRIDE_STATIC(SB_Dispose,   FM_Dispose),
				F_METHODS_OVERRIDE_STATIC(SB_Set,       FM_Set),
				F_METHODS_OVERRIDE_STATIC(SB_Get,       FM_Get),
				F_METHODS_OVERRIDE_STATIC(SB_Setup,     FM_Element_Setup),
				F_METHODS_OVERRIDE_STATIC(SB_Cleanup,   FM_Element_Cleanup),

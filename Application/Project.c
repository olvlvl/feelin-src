...
$VER: 11.00 (2005/12/08)
	...
	[GROG] io_Command = TR_ADDREQUEST forgotten in App_AddSignal.
...
F_METHOD_PROTO(void,App_AddSignalHandler);
F_METHOD_PROTO(void,App_RemSignalHandler);
F_METHOD_PROTO(void,App_Update);
F_METHOD_PROTO(void,App_AddStyleSheet);
F_METHOD_PROTO(void,App_RemStyleSheet);
F_METHOD_PROTO(void,App_Post);
F_METHOD_PROTO(void,App_PostClean);
...
//				  F_ATTRIBUTES_ADD_STATIC("Application",    FV_TYPE_OBJECT,  FA_Application),
			...
			STATIC F_METHODS_ARRAY =
			{
				...
				F_METHODS_ADD_BOTH(App_Post,                "Post", 			FM_Application_Post),
				F_METHODS_ADD_BOTH(App_PostClean,           "PostClean", 		FM_Application_PostClean),
				F_METHODS_ADD_BOTH(App_PushMethod,   		"PushMethod",       FM_Application_PushMethod),
				F_METHODS_ADD_BOTH(App_AddSignalHandler,    "AddSignalHandler", FM_Application_CreateSignalHandler),
				F_METHODS_ADD_BOTH(App_RemSignalHandler,    "RemSignalHandler", FM_Application_DeleteSignalHandler),
				F_METHODS_ADD_BOTH(App_AddStyleSheet,       "AddStyleSheet",    FM_Application_AddStyleSheet),
				F_METHODS_ADD_BOTH(App_RemStyleSheet,       "RemStyleSheet",    FM_Application_RemStyleSheet),

...
///Class
		case FV_Query_ClassTags:
		{
			...
			{
				F_METHODS_OVERRIDE_STATIC(Bar_New, FM_New),
				F_METHODS_OVERRIDE_STATIC(Bar_Get, FM_Get),
				F_METHODS_OVERRIDE_STATIC(Bar_Setup, FM_Element_Setup),
				F_METHODS_OVERRIDE_STATIC(Bar_Cleanup, FM_Element_Cleanup),
				F_METHODS_OVERRIDE_STATIC(Bar_AskMinMax, FM_Area_AskMinMax),
				F_METHODS_OVERRIDE_STATIC(Bar_Draw, FM_Area_Draw),

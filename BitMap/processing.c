    ...
    switch (Msg->ProcMethod)
    {
        ...
        case FV_BitMap_AddProcessing_Convert:
        {
            ...
            if (node)
            {
                ...
                node->func = bitmap_processing_convert;
        ...
        case FV_BitMap_AddProcessing_Tint:
        {
            ...
            if (node)
            {
                ...
                node->func = bitmap_processing_tint;
        ...
        case FV_BitMap_AddProcessing_Radial:
        {
            ...
            if (node)
            {
                ...
                node->func = bitmap_processing_radial;
            }
        }
        break;
        //+
        ...
        case FV_BitMap_AddProcessing_Scale:
        {
            ...
            if (node)
            {
                ...
                node->func = bitmap_processing_scale;
        ...
        case FV_BitMap_AddProcessing_Blur:
        {
            ...
            if (node)
            {
                ...
                node->func = bitmap_processing_blur;
            }
        }
        break;
        ///+

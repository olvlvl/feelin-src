...
/*
   ...
   dégradé, je la testerais un jour pour comparer les performances...

   GOFROMIEL @ HOMBRE: A ben s'il  y  a  une  fonction  exprès,  tu  devrais
   l'utiliser. J'ai écris celle-ci parce qu'il n'y a rien sous classic.

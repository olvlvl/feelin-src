...
///Class
        case FV_Query_ClassTags:
        {
            ...
            STATIC F_METHODS_ARRAY =
            {
                ...
                F_METHODS_ADD_STATIC(WinServer_New,         FM_New),
                F_METHODS_ADD_STATIC(WinServer_Dispose,     FM_Dispose),
                F_METHODS_ADD_STATIC(WinServer_AddMember,   FM_AddMember),
                F_METHODS_ADD_STATIC(WinServer_RemMember,   FM_RemMember),

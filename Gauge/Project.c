...
///Class
        case FV_Query_ClassTags:
        {
            ...
            STATIC F_METHODS_ARRAY =
            {
                ...
                F_METHODS_ADD_STATIC(Gauge_Setup,   FM_Element_Setup),
                F_METHODS_ADD_STATIC(Gauge_Cleanup, FM_Element_Cleanup),
 
                F_METHODS_ADD_STATIC(Gauge_AskMinMax,   FM_Area_AskMinMax),
                F_METHODS_ADD_STATIC(Gauge_Draw,        FM_Area_Draw),
